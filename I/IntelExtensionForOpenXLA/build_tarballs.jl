...
name = "IntelExtensionForOpenXLA"
version = v"0.6.0"

generic_sources = [
    GitSource("https://github.com/intel/intel-extension-for-openxla/",
        "85c05dd19f42333b428ee0f9b579035798695723")
...
products = [
    LibraryProduct(["libpjrt_plugin_xpu"], :libpjrt_plugin_xpu),
]
